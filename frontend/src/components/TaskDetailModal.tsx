...
export function TaskDetailModal({ task, isOpen, onClose }: TaskDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/55 p-4 backdrop-blur-sm">
      <div className="flex h-[90vh] w-full max-w-5xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl dark:bg-zinc-900">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 text-sm font-medium transition-colors ${activeTab === tab.key ? 'border-b-2 border-rose-500 text-rose-500' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400'}`}
              >
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden">
          {activeTab === 'overview' && (
            <div className="grid min-h-0 flex-1 gap-6 overflow-y-auto p-6 lg:grid-cols-[1.3fr_0.7fr]">
